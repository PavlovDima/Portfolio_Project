...
class ChromeSearch(unittest.TestCase):
    ...
    def test_search_chrome(self):
        ...
        time.sleep (2)
        driver.find_element(By.ID, "input_input_passwordInput_SM_ROOT_COMP742").send_keys("123")
        time.sleep (2)
        ...
        # verify and print "Passwords must be at least 4 characters long. Try again." is present
        print (driver.find_element (By.ID, "siteMembersInputErrorMessage_passwordInput_SM_ROOT_COMP747").text)
